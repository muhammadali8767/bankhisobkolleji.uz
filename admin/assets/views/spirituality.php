...
<h1>Kolledj Ma'naviy ishlari</h1>
  <ul class="media-list">
    ...
    ?>                
        <li class="media">
          <a class="pull-left" href="#" style="width: 200px; height: 160px;">
            <img class="media-object img-thumbnail" data-src="holder.js/64x64" alt="" src="img/spirituality/<?=$key[image]?>"> 
          </a>
          ...
          <p>
            ...
            <a href="index.php?view=spiritualityedit&id=<?=$key[id]?>" class="btn btn-sm btn-primary">O'zgartirish</a>
            <a href="del.php?id=<?=$key[id]?>&c=spirituality&path=img/spirituality/" class="btn btn-sm btn-danger"><i class="fa fa-times fa-fw"></i>O'chirish</a>
          </p>
        </li>            
    <?php
      endforeach;
...
<div class="col-sm-12">
  ...
  <div class="col-sm-3"></div>
    ...
    <a href="index.php?view=spiritualityadd" class="btn btn-sm btn-primary">Ma'naviy ishlar qo'shish</a>
    <?php
